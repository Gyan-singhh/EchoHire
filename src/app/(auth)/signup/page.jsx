...
import { signupUser } from "@/lib/http/api";
      ...
      <Card className="w-full max-w-md mx-4 shadow-2xl border-0 bg-white/80 dark:bg-[#0B1F1F]/90 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:shadow-xl">
        ...
        <CardContent className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <FiUser className="text-lg text-teal-600 dark:text-cyan-400 group-focus-within:text-cyan-500 transition-colors" />
              </div>
              <Input
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <FiUserCheck className="text-lg text-teal-600 dark:text-cyan-400 group-focus-within:text-cyan-500 transition-colors" />
              </div>
              <select
                name="role"
                value={form.role}
                onChange={handleChange}
                className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 dark:border-cyan-800 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 dark:focus:ring-cyan-800 bg-white dark:bg-[#0D2F2B]/50 transition-all duration-200 group-hover:border-cyan-300 dark:group-hover:border-cyan-700 rounded-md appearance-none cursor-pointer"
              >
          ...
          <div className="flex items-center justify-between pt-2">
            <span className="text-xs text-gray-500 dark:text-cyan-300">
              Secure registration
            </span>
